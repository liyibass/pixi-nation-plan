        ...
        tabContent: [
          {
            type: 'paragraph',
            content:
              '1.彰化縣未來 20 年發展重點：近 10 年人口數持續下降，希望透過規劃重大建設，吸引外來人口移入彰化，並藉由擴大都市計畫區，把人留住。',
          },
          {
            type: 'paragraph',
            content:
              '2.目前都市化程度太低，排名全國倒數第三。未來集中發展彰化市、員林市兩大都市群，輔以田中鎮、北斗鎮次都市群，目標是 2036 年人口數維持 127 萬人，與現況持平。',
          },
          {
            type: 'paragraph',
            content:
              '3.5 年內有具體規劃的開發案，包含新增約 292.28 公頃住商用地和 73.76 公頃產業用地的「擴大彰化市都市計畫」、用來輔導未登記工廠的水五金田園生產聚落特定區，以及二林精密機械產業園區，預估會新增 109.06 公頃的工業用地。',
          },
          {
            type: 'paragraph',
            content:
              '4.近年成為違章工廠重災區，主要集中和美鎮、彰化市、 鹿港鎮、福興鄉、秀水鄉、埔鹽鄉及花壇鄉，預計 2036 年優先處理 70％ 未登記工廠，規劃 3 處聚落輔導區，包括鹿港鎮、和美鎮、彰北地區。',
          },
        ],
      },
      {
        ...
        tabContent: [
          ...
          },
          {
            type: 'paragraph',
            content:
              '<bold>縣府：</bold>過去因彰化市、和美等彰北地區的都市土地發展飽和，導致都市化人口外流。未來擬透過重大建設吸引人才，並擴大彰北地區的都市計畫，把人留在縣內。',
          },
          {
            type: 'paragraph',
            content:
              '<bold>營建署：</bold>擴大都市就能留住人口嗎？企劃書中提到重大建設將可引入 5 萬 6600 人，判斷的依據是什麼？怎樣防止臺中市把彰化縣人口吸走？',
          },
        ],
      },
      {
        ...
        tabContent: [
          ...
          {
            type: 'title',
            content: '5 年內想推動 5 大開發案？  ',
          },
          {
            type: 'paragraph',
            content:
              '縣府原本提案， 5 年內想推動打鐵厝南北側產業園區、二林精密機械產業園區、彰化水五金田園生產聚落特定區和擴大彰化市都市計畫，新增面積達 1724 公頃。',
          },
          {
            type: 'paragraph',
            content:
          ...
          {
            type: 'paragraph',
            content: '縣府規劃三處未登記工廠聚落輔導區，總量約 1595 公頃。',
          },
          {
            type: 'paragraph',
            content:
              '<bold>環團：</bold>縣府非常積極輔導未登工廠取得「特定工廠登記」，讓工廠有 20 年合法用地資格，根本無須遷廠。另根據經濟部清查，彰化縣有 73.8 公頃的閒置用地，這些地都可以用，為什麼一定要開發？',
          },
          {
            type: 'paragraph',
            content:
        ...
        tabContent: [
          {
            type: 'paragraph',
            content:
              '1.雲林縣未來 20 年發展重點：有全臺最大的「宜維護農地」面積，超過 8 萬公頃，提倡將「農業權入憲」，農民的權益應該由各縣市共同負擔，而不是歸責於農業大縣，同時希望政府給予農地所有權人必要的補償，彌補因為開發受限所造成的經濟損失。',
          },
          {
            type: 'paragraph',
            content:
              '2.預估 2036 年人口略減，以麥寮鄉、斗六市、虎尾鎮為人口的重點區域，新增住商用地 602.8 公頃。縣府理由是：麥寮工業區都市人口飽和、斗六有雲林科技大學學生的宿舍需求、高鐵虎尾站通車後，周邊呈現蔓延發展。',
          },
          {
            type: 'paragraph',
            content:
              '3.地層下陷問題嚴重，在高鐵沿線 150 公尺禁限建範圍，劃設全國唯一的「國土復育促進地區」。',
          },
          {
            type: 'paragraph',
            content:
              '4.200 多座宗教建築坐落在國土保育區、農業發展區，持續協助改善違規情況，輔導合法化。',
          },
        ],
      },
      {
        ...
        tabContent: [
          ...
          {
            type: 'title',
            content: '麥寮特定區要新增 3155 公頃的開發面積？ ',
          },
          {
            type: 'paragraph',
            content:
              '<bold>縣府：</bold>麥寮工業區已百分之百飽和，周邊的都市計畫人口發展率為 119%，有開發的必要。第一期預計先開發緊鄰既有都市計畫區的 200 公頃土地，其餘 2955 公頃則改列農業發展地區，視未來發展情況決定。',
          },
          {
            type: 'paragraph',
            content:
              '<bold>營建署：</bold>國土計畫每 5 年可以通盤檢討，建議雲林縣政府「分期分區」方式辦理，如果地方政府有具體新增未來發展地區的需要，可以 5 年後再提出。',
          },
        ],
      },
      {
        ...
        tabContent: [
          ...
          },
          {
            type: 'paragraph',
            content:
              '有 14 鄉鎮存在地層下陷的問題，其中以台西鄉、口湖鄉、四湖鄉等沿海地區和高鐵沿線尤其嚴重。',
          },
          {
            type: 'paragraph',
          ...
          },
          {
            type: 'paragraph',
            content:
              '<bold>經濟部：</bold>2001 年雲林縣嚴重地層下陷面積是 610.5 平方公里，目前降低到 200 平方公里，已經減緩很多，已提出第二期防治計畫。',
          },
        ],
      },

      {
        ...
        tabContent: [
          ...
          },
          {
            type: 'paragraph',
            content:
              '林內焚化廠完工 16 年未啟用，目前垃圾都是委託嘉義縣代為處理，部分垃圾暫置各鄉鎮衛生掩埋場內。',
          },
          {
            type: 'paragraph',
            content:
              '<bold>縣府：</bold>規劃精進型 MT 計畫，透過機器分選減少廢棄物，並產製 RDF（廢棄物衍生燃料）作為鍋爐燃料。',
          },
        ],
      },
    ],
        ...
        tabContent: [
          {
            type: 'paragraph',
            content:
              '1.嘉義縣未來 20 年發展重點：是全國人口負成長與老化指數最高的城市，要透過引進產業園區，吸引外地的青壯年就業與入籍。',
          },
          {
            type: 'paragraph',
            content:
              '2.5 年內有具體規劃的開發案包括：迎接臺商回流的水上鄉南靖農場工業園區、中埔鄉公館農場工業園區等，以及 3 處未登記工廠聚落輔導區，位於水上鄉、民雄鄉、新港鄉，總開發面積達 767 公頃。',
          },
          {
            type: 'paragraph',
            content:
              '3.原本想在 5 年內推動東石鄉、番路鄉、竹崎鄉新增都市計畫，以及大林鎮擴大都市計畫，審議大會時全數被退件，調整為 5 至 20 年的發展計畫。',
          },
        ],
      },
      {
        ...
        tabContent: [
          ...
          },
          {
            type: 'paragraph',
            content:
              '<bold>縣府：</bold>產業園區會帶人進來，大埔美智慧型工業園區已經招商招滿，再加上新增的馬稠後產業園區，預期會吸引 3.8 萬來自雲林、嘉義市、臺南縣市的人口。',
          },
          {
            type: 'paragraph',
            content:
      ...
      },
      {
        ...
        tabContent: [
          ...
          },
          {
            type: 'paragraph',
            content:
              '目前大約有 107 公頃林班地，例如奮起湖老街，作為住宅、零售及餐飲設施等使用。',
          },
          {
            type: 'paragraph',
            content:
          ...
          },
          {
            type: 'paragraph',
            content:
              '<bold>林務局：</bold>各縣市的林班地也在解編當中，應採通案考量，會在 2025 年前積極趕辦。',
          },
          {
            type: 'paragraph',
            content:
        ...
        tabContent: [
          {
            type: 'paragraph',
            content:
              '1.臺南市未來 20 年發展重點：都市人口 150 萬，佔全市總人口將近 80％，鄉村人口流失嚴重，目標是縫合都市和鄉村的落差。',
          },
          {
            type: 'paragraph',
            content:
              '2.5 年內有具體規劃的新訂、擴大都市計畫共三個，落在七股區、北門區跟安平區，共 218 公頃；另外會推動的重大建設計畫包括新市產業園區、綠能產業園區和臺灣三部曲歷史文化區 BOT 案，前兩者開發涉及優良農地流失、破壞生態，農民抗爭持續至今。',
          },
        ],
      },
      {
        ...
        tabContent: [
          ...
          },
          {
            type: 'paragraph',
            content:
              '臺南發展集中在都市計畫區，偏鄉地區產業流失嚴重，人口持續減少，5 年內維持 38 萬人都很困難。',
          },
          {
            type: 'paragraph',
            content:
        ...
        tabContent: [
          {
            type: 'paragraph',
            content:
              '1.高雄市未來 20 年發展重點：都市與鄉村的人口分布是全臺最失衡，9 成聚集在都市，要靠投入重大建設吸引外來人口，縫合城鄉差距。',
          },
          {
            type: 'paragraph',
            content:
              '2.5 年內要推 14 個開發案，包括在燕巢區、橋頭區新增 153.4 公頃的住商用地，在小港區、岡山區新增 63.13 的工業用地，在岡山區、仁武區、鳥松區設置未登記工廠聚落輔導區，共 321.46 公頃。',
          },
          {
            type: 'paragraph',
            content:
              '3.其中面積最大的開發案是六龜區寶來不老溫泉觀光休閒區，多達 405.05 公頃。2009 年莫拉克風災造成嚴重的山崩和土石流，一直有地質脆弱的疑慮。',
          },
          {
            type: 'paragraph',
            content:
      ...
      },
      {
        ...
        tabContent: [
          ...
          },
          {
            type: 'paragraph',
            content:
              '<bold>審查委員：</bold>過去 10 年人口無顯著成長，已經被臺中市超車；現在只有 1 成的人口在鄉村，遠比全國平均的 8:2 更加失衡，未來鄉村地區只會萎縮不能成長。',
          },
          {
            type: 'paragraph',
            content:
      ...
      },
      {
        ...
        tabContent: [
          ...
          },
          {
            type: 'paragraph',
            content:
              '<bold>市府：</bold>住宅供給雖然充裕，但有超過四成屬於 30 年以上老屋，必須預先儲備住宅更新的空間。',
          },
        ],
      },
      {
        ...
        tabContent: [
          ...
          },
          {
            type: 'paragraph',
            content:
              '<bold>市府：</bold>將推動更換老舊的自來水管線、鼓勵工廠廢水回收，降低水資源浪費，並優先引進低耗水產業。自來水公司於高屏溪沿岸進行溪埔及大泉伏流水開發，預計民國 110 年完成。',
          },
        ],
      },
      {
        ...
        tabContent: [
          {
            type: 'paragraph',
            content:
              '1.屏東縣未來 20 年發展重點：擔心土地劃設成農業區後會限制用途，例如魚塭用地可能無法合法，因此低報優良農地的面積，都市農業區也全轉為都市發展使用。',
          },
          {
            type: 'paragraph',
            content:
              '2.預計 2035 年大部分的鄉鎮市人口都會減少，因此不再新增住商用地。5 年內有具體規劃的工業區位於屏東市、新園鄉，總共 22.08 公頃。',
          },
          {
            type: 'paragraph',
            content:
              '3.未登記工廠面積約 1015.84 公頃，整體主要分布於屏北地區，輔導區應會落在長治鄉、麟洛鄉、屏東市、新園鄉、崁頂鄉、潮州鎮、東港鎮、林邊鄉。',
          },
        ],
      },
      {
        ...
        tabContent: [
          {
            type: 'paragraph',
            content:
              '1.臺東縣未來 20 年發展重點：觀光快速發展，到 2036 年戶籍人口和觀光人口達 38.9 萬，比現居人口 21 萬人高出許多，目標是補足公共建設，包括設置 3 座綠能發電廠、開發地下水或伏流水、重啟焚化爐。',
          },
          {
            type: 'paragraph',
            content:
              '2.少子化＋人口外移，預估 2036 年人口會減少一萬多人，無新增住商用地。5 年內有具體發展規劃的開發案包括深層海水產業發展園區、知本濕地光電場、城鎮之心南迴驛建設計畫、小野柳風景特定區，共 306 公頃，無額外的工業用地。',
          },
          {
            type: 'paragraph',
            content:
              '3.沒有提供任何 5 至 20 年內的開發規劃，縣府稱未來的城鄉發展會以既有的都市計畫地區為優先，避免浪費公共資源。',
          },
        ],
      },
      {
        ...
        tabContent: [
          {
            type: 'paragraph',
            content:
              '1.花蓮縣未來 20 年發展重點：人口 2035 年雖預估會減少，但包括花蓮市、吉安鄉、新城鄉、壽豐鄉、秀林鄉等北花蓮地區已發展飽和，仍劃設了 68 公頃的住商用地。',
          },
          {
            type: 'paragraph',
            content:
              '2.5-20 年的開發重點地區多達 3270 公頃。縣府表示，有四處位於鄉鎮公所附近，是因為公共設施不足，準備改善當地的生活機能；林田山、七星潭、花蓮溪出海口、瑞穗溫泉等五處因應觀光發展，預留發展彈性。剩餘一處則位於吉安工業區周邊，預留為輔導未登記工廠的空間。',
          },
          {
            type: 'paragraph',
            content:
              '3.原住民人口占 28%，原保地建地面積卻僅有全縣住宅用地的 13%，部落建築用地非常不足，導致原住民離開部落。正與部落溝通，馬太鞍、太巴塱等部落可能優先做鄉村地區整體規劃。',
          },
        ],
      },
      {
        ...
        tabContent: [
          ...
          },
          {
            type: 'paragraph',
            content:
              '鳳林鎮、 壽豐鄉、光復鄉、豐濱鄉、瑞穗鄉及富里鄉等 6 鄉鎮的老化指數高達 200%，65 歲以上人口是 0-14 歲人口的兩倍，10 年後老年人口將再增一倍。',
          },
          {
            type: 'paragraph',
            content:
      ...
      },
      {
        ...
        tabContent: [
          ...
          },
          {
            type: 'paragraph',
            content:
              '人口預估會減少，卻打算新增 360 公頃住商及產業用地，之後被大砍到 68 公頃住商用地。',
          },
          {
            type: 'paragraph',
            content:
        ...
        tabContent: [
          {
            type: 'paragraph',
            content:
              '1.南投縣未來 20 年發展重點：近 10 年人口持續減少，要靠重大產業建設吸引人口，5 年內有具體規劃的開發案包括南投市工業區、竹山鎮竹藝產業園區、名間鄉大中鋼鐵擴展計畫，共新增 40.22 公頃的工業用地',
          },
          {
            type: 'paragraph',
            content:
      ...
      },
      {
        ...
        tabContent: [
          ...
          },
          {
            type: 'paragraph',
            content:
              '縣內沒有焚化爐，原本都是委託彰化縣和臺中市代為處理，但其從 2016 年開始因焚化爐老舊等因素無法提供協助，垃圾堆積問題嚴重。',
          },
          {
            type: 'paragraph',
            content:
              '<bold>縣府：</bold>現階段僅能轉運至外縣市焚化廠代為處理，並設置多元垃圾處理設施；未來擬在竹山鎮設置綠能永續中心，自主處理廢棄物，是 2026-2035 年的發展重點。',
          },
        ],
      },
      {
        ...
        tabContent: [
          ...
          },
          {
            type: 'paragraph',
            content:
              '縣府原本預計新增 1900 公頃住商用地，其中的重大開發案「新訂中興交流道特定區計畫」5 年內有具體規劃的住商和產業用地只有 141 公頃，卻劃設了 582 公頃。',
          },
          {
            type: 'paragraph',
            content:
          ...
          },
          {
            type: 'paragraph',
            content:
              '<bold>審查委員：</bold>未來預計成長人口才 2-3 萬，住商需求土地為什麼需要這麼多？',
          },
          {
            type: 'paragraph',
            content:
              '<bold>縣府：</bold>草屯、中興新村、南投都市計畫區已經飽和，有往外擴散的情形，希望藉由「新訂中興交流道特定區計畫」來降低隨意發展的情況。目前以 582 公頃為主要發展方向，剩餘的住商用地則是針對未來發展，目前尚未有具體規劃。',
          },
        ],
      },
    ],
        ...
        tabContent: [
          {
            type: 'paragraph',
            content:
              '1.澎湖縣未來 20 年發展重點：觀光需求成長，規劃吉貝和七美各新建一座海水淡化廠、馬公海淡二廠二期工程，確保供水無虞。垃圾目前代請高雄市所管焚化爐代為處理，還需要規劃新方法。',
          },
          {
            type: 'paragraph',
            content:
              '2.海洋資源豐富，島嶼共 90 座，海洋資源地區比例超過全縣 9 成。南方四島國家公園、玄武岩自然保留區、望安島綠蠵龜產卵棲地保護區、貓嶼海鳥保護區等均設為國土保育區。',
          },
          {
            type: 'paragraph',
            content:
              '3.5 年內有具體發展規劃的案件共 10 件，包括 4 件度假區開發案，共新增 44.25 公頃的觀光用地，地點位在隘門、漁翁島、七美月鯉灣、吉貝。',
          },
        ],
      },
      {
        ...
        tabContent: [
          ...
          },
          {
            type: 'paragraph',
            content:
              '農地相對稀少，部分弱勢民眾面臨「有地無屋」窘境，因此自民國 83 年起形成特殊的「農」變「建」制度。近年逐漸浮濫，甚至淪為農地炒作管道，曾遭監察院糾正。',
          },
          {
            type: 'paragraph',
            content:
          ...
          {
            type: 'title',
            content: '一次推 12 處重大建設或度假村計畫',
          },

          {
            type: 'paragraph',
            content:
              '<bold>審查委員：</bold>12 案只有少處完成招商，大多還未完成核定，且開發案大多在海岸地區，或是選址位於海灣的度假村，容易受到海平面上升或海嘯影響。',
          },
          {
            type: 'paragraph',
            content:
              '<bold>縣府：</bold>的確沒有考量氣候變遷的對策，相信將來個別案件在推動建設時，投資單位一定會考慮氣候風險進來。如果建設案未能即時完成，將納入未來 5 至 20 年的發展重點。',
          },
        ],
      },
    ],
